...
public class StateObservationMulti : StateObservation {
     ...
     */
    public StateObservationMulti(ForwardModel a_model, int playerID) : base(a_model, playerID) {
     ...
     */
    public List<VGDLAvatarActions> getAvailableActions(int playerID) { return model.getAvatarActions(playerID, true); }
     ...
     */
    public float getGameScore(int playerID)
    {
     ...
     */
    public bool isGameOver() { return model.isMultiGameOver(); }
     ...
     */
    public string getAvatarType(int playerID) { return model.getAvatarType(playerID); }
     ...
     */
    public bool isAvatarAlive(int playerID) {return model.isAvatarAlive(playerID);}
