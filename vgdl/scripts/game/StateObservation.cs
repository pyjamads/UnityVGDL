...
public class StateObservation {
     ...
     */
    public VGDLUtils.VGDLGameStates currentGameState;
     ...
     */
    public VGDLUtils.VGDLGameStates getGameState()
    {
     ...
     */
    public List<VGDLAvatarActions> getAvailableActions()
    {
     ...
     * @return the available actions.
     */
    public List<VGDLAvatarActions> getAvailableActions(bool includeNIL)
    {
     ...
     */
    public VGDLPlayerOutcomes getGameWinner()
    {
     ...
     */
    public VGDLAvatarActions getAvatarLastAction()
    {
     ...
     */
    public bool isAvatarAlive() {return model.isAvatarAlive();}
    ...
    {
        return model.getNPCPositions(Vector2.negativeInfinity);
    }
     ...
     * @return Observations of NPCs in the game.
     */
    public List<Observation>[] getNPCPositions(Vector2 reference)
    {
    ...
    public List<Observation>[] getImmovablePositions() {
        return model.getImmovablePositions(Vector2.negativeInfinity);
    }
     ...
     * @return Observations of immovable sprites in the game.
     */
    public List<Observation>[] getImmovablePositions(Vector2 reference) {
    ...
    public List<Observation>[] getMovablePositions() {
        return model.getMovablePositions(Vector2.negativeInfinity);
    }
     ...
     * @return Observations of movable (not NPCs) sprites in the game.
     */
    public List<Observation>[] getMovablePositions(Vector2 reference) {
    ...
    public List<Observation>[] getResourcesPositions() {
        return model.getResourcesPositions(Vector2.negativeInfinity);
    }
     ...
     * @return Observations of resources in the game.
     */
    public List<Observation>[] getResourcesPositions(Vector2 reference) {
    ...
    public List<Observation>[] getPortalsPositions() {
        return model.getPortalsPositions(Vector2.negativeInfinity);
    }
     ...
     * @return Observations of portals in the game.
     */
    public List<Observation>[] getPortalsPositions(Vector2 reference) {
    ...
    public List<Observation>[] getFromAvatarSpritesPositions() {
        return model.getFromAvatarSpPositions(Vector2.negativeInfinity);
    }
     ...
     * @return Observations of sprites the avatar created.
     */
    public List<Observation>[] getFromAvatarSpritesPositions(Vector2 reference) {
     ...
     */
    public VGDLInputHandler getKeyHandler(int playerID) { return model.avatars[playerID].getKeyHandler(); }
