...
public class killIfFast : VGDLEffect
{
    ...
    public override void execute(VGDLSprite sprite1, VGDLSprite sprite2, VGDLGame game)
    {
        if(sprite1 == null || sprite2 == null){
            throw new ArgumentException("Neither 1st not 2nd sprite can be EOS with KillIfFast interaction.");
        }
        ...
        else
        {
            ...
            Vector2 vv = new Vector2(vvx,vvy);
