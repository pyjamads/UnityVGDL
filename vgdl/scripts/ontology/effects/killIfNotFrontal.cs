...
public class killIfNotFrontal : VGDLEffect
{
    public killIfNotFrontal()
    {
        is_kill_effect = true;
    }
    ...
    public override void execute(VGDLSprite sprite1, VGDLSprite sprite2, VGDLGame game)
    {
        ...
        {
            throw new ArgumentException("Neither the 1st nor 2nd sprite can be EOS with KillIfNotFrontal interaction.");
        }
